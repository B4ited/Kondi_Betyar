...
import hu.nye.kondibetyar.edzes.SajatEdzesActivity;
import hu.nye.kondibetyar.edzes.edit.EditTervekActivity;


public class GyakorlatokEgyeniActivity extends AppCompatActivity {
    ...
    public void loadButtonData(){
        myDb=new DatabaseHelper(GyakorlatokEgyeniActivity.this);
